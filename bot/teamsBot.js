...
const rawTestCard = require("./adaptiveCards/test.json");
  ...
  constructor() {
    ...
    this.onMessage(async (context, next) => {
      ...
      switch (txt) {
        ...
        case "test": {
          const card = cardTools.AdaptiveCard.declare(rawTestCard).render();
          await context.sendActivities({ attachment: [CardFactory.adaptiveCard(card)]});
          break;
        }
        /**
         * case "yourCommand": {
